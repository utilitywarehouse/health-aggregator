module github.com/utilitywarehouse/health-aggregator
...
require (
	...
	github.com/utilitywarehouse/go-operational-health-checks v0.0.0-20180921080305-a7d124d4246b
	github.com/utilitywarehouse/go-pubsub v1.0.0 // indirect
