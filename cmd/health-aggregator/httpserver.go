...
func newHTTPServer(port int, router *mux.Router, writeTimeout int, readTimeout int, allowedCorsMethods handlers.CORSOption, allowedCorsOrigins handlers.CORSOption) *http.Server {
	return &http.Server{
